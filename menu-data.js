window.menuData = [
  ...
  },
  {
    ...
    items: [
      { number: "DR1", groupEn: "Everfresh juice", nameEn: "Everfresh Orange Juice", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR2", groupEn: "Everfresh juice", nameEn: "Everfresh Cranberry Juice", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR3", groupEn: "Everfresh juice", nameEn: "Everfresh Cranberry Apple Juice", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR4", groupEn: "Everfresh juice", nameEn: "Everfresh Apple Juice", nameZh: "", prices: [{ amount: "2.50" }] },
      ...
      { number: "DR18", groupEn: "2-liter soda", nameEn: "Pepsi (2-Liter)", nameZh: "", prices: [{ amount: "4.00" }] },
      { number: "DR19", groupEn: "2-liter soda", nameEn: "Canada Dry Ginger Ale (2-Liter)", nameZh: "", prices: [{ amount: "4.00" }] },
      { number: "DR20", groupEn: "2-liter soda", nameEn: "Sunkist Orange (2-Liter)", nameZh: "", prices: [{ amount: "4.00" }] },
      { number: "DR21", groupEn: "Bottle soda ($2.25)", nameEn: "Pepsi (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR22", groupEn: "Bottle soda ($2.25)", nameEn: "Pepsi Cherry (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR23", groupEn: "Bottle soda ($2.25)", nameEn: "Diet Pepsi (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR24", groupEn: "Bottle soda ($2.25)", nameEn: "Tahitian Treat (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR25", groupEn: "Bottle soda ($2.25)", nameEn: "Mountain Dew (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR26", groupEn: "Bottle soda ($2.25)", nameEn: "Canada Dry Ginger Ale (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR27", groupEn: "Bottle soda ($2.25)", nameEn: "Canada Dry Pineapple (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      ...
      { number: "DR31", groupEn: "Hug", nameEn: "Hug", nameZh: "", note: "Assorted flavors.", prices: [{ amount: "1.25" }] },
      { number: "DR32", groupEn: "Red Bull", nameEn: "Red Bull", nameZh: "", prices: [{ amount: "3.00" }] },
      { number: "DR33", groupEn: "Gatorade", nameEn: "Gatorade Cool Blue (blue)", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR34", groupEn: "Gatorade", nameEn: "Gatorade Lime", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR35", groupEn: "Gatorade", nameEn: "Gatorade Fruit Punch", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR36", groupEn: "Bottle soda ($2.50)", nameEn: "Coke (Bottle)", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR37", groupEn: "Bottle soda ($2.50)", nameEn: "Sprite (Bottle)", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR38", groupEn: "Bottle soda ($2.50)", nameEn: "Sunkist Orange (Bottle)", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR39", groupEn: "Bottle soda ($1.25)", nameEn: "Ginger Ale (Bottle)", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR40", groupEn: "Bottle soda ($1.25)", nameEn: "Pineapple (Bottle)", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR41", groupEn: "Bottle soda ($1.25)", nameEn: "Fruit Punch (Bottle)", nameZh: "", prices: [{ amount: "1.25" }] }
    ]
  }
];
