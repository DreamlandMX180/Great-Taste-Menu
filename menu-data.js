window.menuData = [
  ...
  },
  {
    ...
    items: [
      { number: "78", nameEn: "Chicken with Mixed Vegetables", nameZh: "鸡肉什锦蔬菜", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "79", nameEn: "Pepper Chicken with Onion", nameZh: "青椒洋葱鸡", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "80", nameEn: "Chicken with Black Bean Sauce", nameZh: "豆豉鸡", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "81", nameEn: "Chicken with Broccoli", nameZh: "鸡肉西兰花", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "82", nameEn: "Moo Goo Gai Pan", nameZh: "蘑菇鸡片", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "83", nameEn: "Curry Chicken with Onion", nameZh: "咖喱鸡", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }], spicy: true },
      { number: "84", nameEn: "Chicken in Garlic Sauce", nameZh: "鱼香鸡", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }], spicy: true },
      { number: "85", nameEn: "Szechuan Chicken", nameZh: "四川鸡", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }], spicy: true },
      { number: "86", nameEn: "Hunan Chicken", nameZh: "湖南鸡", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }], spicy: true },
      { number: "87", nameEn: "Kung Po Chicken", nameZh: "宫保鸡丁", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }], spicy: true },
      { number: "88", nameEn: "Hot Spicy Chicken", nameZh: "香辣鸡", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }], spicy: true },
      { number: "89", nameEn: "General Tso's Chicken", nameZh: "左宗鸡", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }], spicy: true }
    ]
  },
  {
    id: "beef",
    ...
    note: "Served with white rice. Fried rice +$1. / 配白饭，炒饭加 $1.",
    items: [
      { number: "90", nameEn: "Beef with Mixed Vegetables", nameZh: "牛肉什锦蔬菜", prices: [{ labelEn: "Pt", labelZh: "小", amount: "11.00" }, { labelEn: "Qt", labelZh: "大", amount: "13.00" }] },
      { number: "91", nameEn: "Beef with Scallion", nameZh: "葱爆牛肉", prices: [{ labelEn: "Pt", labelZh: "小", amount: "11.00" }, { labelEn: "Qt", labelZh: "大", amount: "13.00" }] },
      { number: "92", nameEn: "Pepper Steak with Onion", nameZh: "青椒洋葱牛肉", prices: [{ labelEn: "Pt", labelZh: "小", amount: "11.00" }, { labelEn: "Qt", labelZh: "大", amount: "13.00" }] },
      { number: "93", nameEn: "Beef with Mushrooms", nameZh: "蘑菇牛肉", prices: [{ labelEn: "Pt", labelZh: "小", amount: "11.00" }, { labelEn: "Qt", labelZh: "大", amount: "13.00" }] },
      { number: "94", nameEn: "Beef with Broccoli", nameZh: "牛肉西兰花", prices: [{ labelEn: "Pt", labelZh: "小", amount: "11.00" }, { labelEn: "Qt", labelZh: "大", amount: "13.00" }] },
      { number: "95", nameEn: "Beef with Black Bean Sauce", nameZh: "豆豉牛肉", prices: [{ labelEn: "Pt", labelZh: "小", amount: "11.00" }, { labelEn: "Qt", labelZh: "大", amount: "13.00" }] },
      { number: "96", nameEn: "Beef in Garlic Sauce", nameZh: "鱼香牛肉", prices: [{ labelEn: "Pt", labelZh: "小", amount: "11.00" }, { labelEn: "Qt", labelZh: "大", amount: "13.00" }], spicy: true },
      { number: "97", nameEn: "Szechuan Beef", nameZh: "四川牛肉", prices: [{ labelEn: "Pt", labelZh: "小", amount: "11.00" }, { labelEn: "Qt", labelZh: "大", amount: "13.00" }], spicy: true },
      { number: "98", nameEn: "Hunan Beef", nameZh: "湖南牛肉", prices: [{ labelEn: "Pt", labelZh: "小", amount: "11.00" }, { labelEn: "Qt", labelZh: "大", amount: "13.00" }], spicy: true }
    ]
  },
  {
    id: "seafood",
    ...
    note: "Served with white rice. Fried rice +$1. / 配白饭，炒饭加 $1.",
    items: [
      { number: "99", nameEn: "Shrimp with Mixed Vegetables", nameZh: "虾什锦蔬菜", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "100", nameEn: "Shrimp with Lobster Sauce", nameZh: "龙虾酱虾", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "101", nameEn: "Shrimp with Pepper, Tomato & Onion", nameZh: "青椒番茄洋葱虾", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "102", nameEn: "Shrimp with Broccoli", nameZh: "虾西兰花", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "103", nameEn: "Shrimp with Black Bean Sauce", nameZh: "豆豉虾", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "104", nameEn: "Shrimp with Mushrooms", nameZh: "蘑菇虾", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "105", nameEn: "Shrimp with Bean Curds", nameZh: "豆腐虾", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }] },
      { number: "106", nameEn: "Curry Shrimp with Onion", nameZh: "咖喱虾", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "12.00" }], spicy: true },
  ...
  },
  {
    ...
    note: "Served with white rice. Fried rice +$1. / 配白饭，炒饭加 $1.",
    items: [
      { number: "1", nameEn: "Happy Family", nameZh: "全家福", note: "Shrimp, chicken, beef, scallops, pork & lobster meat with mixed vegetables. / 虾、鸡肉、牛肉、鲜贝、叉烧及龙虾肉配杂菜", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "2", nameEn: "Hawaii Five \"O\"", nameZh: "五鲜会", note: "Chunks of crab meat, jumbo shrimp, steak, roast pork & chicken with mixed vegetables. / 蟹肉块、大虾、牛排、叉烧与鸡肉配杂菜", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "3", nameEn: "Four Happiness", nameZh: "大四喜", note: "Shrimp, chicken, pork & lobster meat with mixed vegetables. / 虾、鸡肉、叉烧及龙虾肉配杂菜", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "4", nameEn: "Triple Delight", nameZh: "大三元", note: "Shrimp, beef & chicken with mixed vegetables. / 虾、牛肉与鸡肉配杂菜", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "5", nameEn: "Double Delight", nameZh: "炒双鲜", note: "Jumbo shrimp, chicken & broccoli with Chinese vegetables. / 大虾、鸡肉、西兰花配中式蔬菜", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "6", nameEn: "Four Seasons", nameZh: "炒四季", note: "Crab meat, shrimp, chicken & pork. / 蟹肉、虾、鸡肉与猪肉", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "7", nameEn: "Mandarin Combination", nameZh: "三及第", note: "Jumbo shrimp, chicken, roast pork with vegetables. / 大虾、鸡肉、叉烧配蔬菜", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "8", nameEn: "Sesame Chicken", nameZh: "芝麻鸡", note: "Spring chicken in large chunks, marinated, fried crispy, sauteed with red peppers & sesame seeds in tangy sauce. / 嫩鸡切大块腌制后酥炸，再以红椒与芝麻配酸甜酱汁快炒", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "9", nameEn: "Beef & Scallops", nameZh: "干贝牛", note: "Tender beef with fresh scallops & vegetables in mild brown sauce, served sizzling. / 嫩牛肉配鲜干贝与蔬菜，浇淡口褐色酱汁铁板热上", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "10", nameEn: "Seafood Delight", nameZh: "海鲜大会", note: "Lobster, jumbo shrimp, scallops, crab meat with Chinese vegetables. / 龙虾、大虾、干贝、蟹肉配中式蔬菜", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "11", nameEn: "Sesame Shrimp", nameZh: "芝麻虾", note: "Jumbo shrimp in large chunks, marinated, fried crispy, sauteed with red peppers & sesame seeds in tangy sauce. / 大虾切大块腌制后酥炸，再以红椒与芝麻配酸甜酱汁快炒", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }] },
      { number: "12", nameEn: "Kamphon Delight", nameZh: "炒三鲜", note: "Beef, chicken, roast pork with vegetables in hot pepper sauce. / 牛肉、鸡肉、叉烧配蔬菜，辣椒酱快炒", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }], spicy: true },
      { number: "13", nameEn: "Hunan Triple Crown", nameZh: "湖南三样", note: "Jumbo shrimp, beef, chicken with vegetables in hot garlic sauce. / 大虾、牛肉、鸡肉配蔬菜，辣蒜蓉汁快炒", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }], spicy: true },
      { number: "14", nameEn: "Orange Chicken", nameZh: "陈皮鸡", note: "Sliced chicken dry-sauteed with orange peel in chef's special hot sauce. / 鸡片干煸配陈皮，浇厨师特调辣酱", prices: [{ labelEn: "Pt", labelZh: "小", amount: "10.00" }, { labelEn: "Qt", labelZh: "大", amount: "15.00" }], spicy: true }
    ]
  },
  {
    id: "lunch-special",
  ...
  },
  {
    ...
    items: [
      { number: "DR1", nameEn: "Everfresh Orange Juice", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR2", nameEn: "Everfresh Cranberry Juice", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR3", nameEn: "Everfresh Cranberry Apple Juice", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR4", nameEn: "Everfresh Apple Juice", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR5", nameEn: "Pepsi", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR6", nameEn: "Mountain Dew", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR7", nameEn: "Sprite", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR8", nameEn: "Coke", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR9", nameEn: "Canada Dry Ginger Ale", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR10", nameEn: "Sunkist Orange", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR11", nameEn: "Homemade Lemonade", nameZh: "", prices: [{ amount: "2.00" }] },
      { number: "DR12", nameEn: "Homemade Fruit Punch", nameZh: "", prices: [{ amount: "2.00" }] },
      { number: "DR13", nameEn: "Homemade Pink Lemonade", nameZh: "", prices: [{ amount: "2.00" }] },
      { number: "DR14", nameEn: "Homemade Iced Tea", nameZh: "", prices: [{ amount: "2.00" }] },
      { number: "DR15", nameEn: "Homemade Blue Lemonade", nameZh: "", prices: [{ amount: "2.00" }] },
      { number: "DR16", nameEn: "Small Water Bottle", nameZh: "", prices: [{ amount: "0.75" }] },
      { number: "DR17", nameEn: "Large Water Bottle", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR18", nameEn: "Pepsi (2-Liter)", nameZh: "", prices: [{ amount: "4.00" }] },
      { number: "DR19", nameEn: "Canada Dry Ginger Ale (2-Liter)", nameZh: "", prices: [{ amount: "4.00" }] },
      { number: "DR20", nameEn: "Sunkist Orange (2-Liter)", nameZh: "", prices: [{ amount: "4.00" }] },
      { number: "DR21", nameEn: "Pepsi (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR22", nameEn: "Pepsi Cherry (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR23", nameEn: "Diet Pepsi (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR24", nameEn: "Tahitian Treat (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR25", nameEn: "Mountain Dew (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR26", nameEn: "Canada Dry Ginger Ale (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR27", nameEn: "Canada Dry Pineapple (Bottle)", nameZh: "", prices: [{ amount: "2.25" }] },
      { number: "DR28", nameEn: "Arizona Green Tea", nameZh: "", prices: [{ amount: "1.50" }] },
      { number: "DR29", nameEn: "Arizona Iced Tea", nameZh: "", prices: [{ amount: "1.50" }] },
      { number: "DR30", nameEn: "Arizona Mango", nameZh: "", prices: [{ amount: "1.50" }] },
      { number: "DR31", nameEn: "Hug", nameZh: "", note: "Assorted flavors.", prices: [{ amount: "1.25" }] },
      { number: "DR32", nameEn: "Red Bull", nameZh: "", prices: [{ amount: "3.00" }] },
      { number: "DR33", nameEn: "Gatorade Cool Blue (blue)", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR34", nameEn: "Gatorade Lime", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR35", nameEn: "Gatorade Fruit Punch", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR36", nameEn: "Coke (Bottle)", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR37", nameEn: "Sprite (Bottle)", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR38", nameEn: "Sunkist Orange (Bottle)", nameZh: "", prices: [{ amount: "2.50" }] },
      { number: "DR39", nameEn: "Ginger Ale (Bottle)", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR40", nameEn: "Pineapple (Bottle)", nameZh: "", prices: [{ amount: "1.25" }] },
      { number: "DR41", nameEn: "Fruit Punch (Bottle)", nameZh: "", prices: [{ amount: "1.25" }] }
    ]
  }
];
