...
window.menuData = [
  ...
  },
  {
    ...
    items: [
      { number: "54", nameEn: "Plain Yat", nameZh: "原味伊面", prices: [{ amount: "9.00" }] },
      { number: "55", nameEn: "Pork Yat", nameZh: "叉烧伊面", prices: [{ amount: "9.00" }] },
      { number: "56", nameEn: "Chicken Yat", nameZh: "鸡肉伊面", prices: [{ amount: "8.50" }] },
