window.menuData = [
  ...
  },
  {
    ...
    categoryZh: "",
    note: "Served with white rice. Fried rice +$1.",
    items: [
      { number: "1", nameEn: "Happy Family", nameZh: "", note: "Shrimp, chicken, beef, scallops, pork & lobster meat with mixed vegetables.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "2", nameEn: "Hawaii Five \"O\"", nameZh: "", note: "Chunks of crab meat, jumbo shrimp, steak, roast pork & chicken with mixed vegetables.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "3", nameEn: "Four Happiness", nameZh: "", note: "Shrimp, chicken, pork & lobster meat with mixed vegetables.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "4", nameEn: "Triple Delight", nameZh: "", note: "Shrimp, beef & chicken with mixed vegetables.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "5", nameEn: "Double Delight", nameZh: "", note: "Jumbo shrimp, chicken & broccoli with Chinese vegetables.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "6", nameEn: "Four Seasons", nameZh: "", note: "Crab meat, shrimp, chicken & pork.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "7", nameEn: "Mandarin Combination", nameZh: "", note: "Jumbo shrimp, chicken, roast pork with vegetables.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "8", nameEn: "Sesame Chicken", nameZh: "", note: "Spring chicken in large chunks, marinated, fried crispy, sauteed with red peppers & sesame seeds in tangy sauce.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "9", nameEn: "Beef & Scallops", nameZh: "", note: "Tender beef with fresh scallops & vegetables in mild brown sauce, served sizzling.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "10", nameEn: "Seafood Delight", nameZh: "", note: "Lobster, jumbo shrimp, scallops, crab meat with Chinese vegetables.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "11", nameEn: "Sesame Shrimp", nameZh: "", note: "Jumbo shrimp in large chunks, marinated, fried crispy, sauteed with red peppers & sesame seeds in tangy sauce.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }] },
      { number: "12", nameEn: "Kamphon Delight", nameZh: "", note: "Beef, chicken, roast pork with vegetables in hot pepper sauce.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }], spicy: true },
      { number: "13", nameEn: "Hunan Triple Crown", nameZh: "", note: "Jumbo shrimp, beef, chicken with vegetables in hot garlic sauce.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }], spicy: true },
      { number: "14", nameEn: "Orange Chicken", nameZh: "", note: "Sliced chicken dry-sauteed with orange peel in chef's special hot sauce.", prices: [{ labelEn: "Pt", amount: "10.00" }, { labelEn: "Qt", amount: "15.00" }], spicy: true }
    ]
  },
  {
    id: "lunch-special",
